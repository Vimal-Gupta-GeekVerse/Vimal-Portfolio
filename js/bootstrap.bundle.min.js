...
!(function(t, e) {
        ...
        var s =
          ...
          a = o.reduce(function(e, i) {
            ...
            return (e.top = Kt(
              s.top,
              e.top
            )), (e.right = Qt(s.right, e.right)), (e.bottom = Qt(s.bottom, e.bottom)), (e.left = Kt(s.left, e.left)), e;
          }, xe(t, r, n));
        ...
        h = {
          ...
          setOptions: function(i) {
            ...
            d(), (a.options = Object.assign(
              ...
              reference: Ft(t)
                ? Ce(t)
                : t.contextElement ? Ce(t.contextElement) : [],
              popper: Ce(e)
            });
            var r,
              c,
  ...
  class hi extends z {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._popper = null), (this._parent = this._element.parentNode), (this._menu = Q.next(this._element, ei)[0] || Q.prev(this._element, ei)[0] || Q.findOne(ei, this._parent)), (this._inNavbar = this._detectNavbar());
    }
    static get Default() {
      return li;
    }
    ...
    show() {
      ...
      if (!P.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
        ...
        this._element.focus(), this._element.setAttribute(
          "aria-expanded",
          !0
        ), this._menu.classList.add(Je), this._element.classList.add(
          Je
    ...
    _completeHide(t) {
      if (!P.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
        ...
        this._popper && this._popper.destroy(), this._menu.classList.remove(
          Je
        ), this._element.classList.remove(Je), this._element.setAttribute(
          "aria-expanded",
          "false"
  ...
  P.on(
    ...
    Ge,
    Ze,
    hi.dataApiKeydownHandler
  ), P.on(document, Ge, ei, hi.dataApiKeydownHandler), P.on(document, Ue, hi.clearMenus), P.on(document, "keyup.bs.dropdown.data-api", hi.clearMenus), P.on(
    document,
    Ue,
    Ze,
    function(t) {
  ...
  class gi {
    ...
    reset() {
      this._resetElementAttributes(
        this._element,
        "overflow"
      ), this._resetElementAttributes(this._element, fi), this._resetElementAttributes(di, fi), this._resetElementAttributes(ui, pi);
    }
    isOverflowing() {
  ...
  class yi extends F {
    ...
    show(t) {
      ...
      this._config.isAnimated &&
        d(e), e.classList.add(mi), this._emulateAnimation(() => {
        m(t);
      });
    }
    hide(t) {
  ...
  class Ni extends z {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._dialog = Q.findOne(".modal-dialog", this._element)), (this._backdrop = this._initializeBackDrop()), (this._focustrap = this._initializeFocusTrap()), (this._isShown = !1), (this._isTransitioning = !1), (this._scrollBar = new gi()), this._addEventListeners();
    }
    static get Default() {
      return Si;
    }
          ...
          this._queueCallback(
            () => {
              (this._config.scroll && !this._config.backdrop) ||
                ...
                Pi
              ), this._element.classList.remove(ji), P.trigger(
                this._element,
                "shown.bs.offcanvas",
                { relatedTarget: t }
              );
            ...
            this._queueCallback(
              () => {
                this._element.classList.remove(
                  ...
                  new gi().reset(), P.trigger(this._element, Wi);
              },
              this._element,
              !0
            )
  ...
  P.on(
    ...
    function(t) {
      ...
      i && i !== e && zi.getInstance(i).hide(), zi
  ...
  class cn extends z {
    ...
    dispose() {
      clearTimeout(
        this._timeout
      ), P.off(this._element.closest(en), nn, this._hideModalHandler), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose();
    }
    show() {
    ...
    _createTipElement(t) {
      ...
      return e.setAttribute(
        "id",
        i
      ), this._isAnimated() && e.classList.add(Zi), e;
    }
    setContent(t) {
  ...
  class kn extends z {
    ...
    _toggleDropDown(t, e) {
      ...
      n(
        ".dropdown-toggle",
        En
      ), n(".dropdown-menu", Cn), i.setAttribute("aria-expanded", e);
    }
  ...
  P.on(document, "click.bs.tab", On, function(t) {
    ["A", "AREA"].includes(this.tagName) &&
      t.preventDefault(), l(this) || kn.getOrCreateInstance(this).show();
    ...
    show() {
      P.trigger(this._element, "show.bs.toast").defaultPrevented ||
        (
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove(Sn), P.trigger(
                this._element,
                "shown.bs.toast"
      ...
      this.isShown() &&
        (P.trigger(this._element, "hide.bs.toast").defaultPrevented ||
          (
            ...
            this._queueCallback(
              () => {
                this._element.classList.add(Ln), this._element.classList.remove(
                  Sn,
                  Dn
  ...
  return q(
    Pn
  ), g(Pn), { Alert: R, Button: K, Carousel: at, Collapse: pt, Dropdown: hi, Modal: Ni, Offcanvas: zi, Popover: un, ScrollSpy: bn, Tab: kn, Toast: Pn, Tooltip: cn };
});
